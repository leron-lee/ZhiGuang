...
//初始值
function preselect(s1, s2, s3) {
    if (s1 != "") {
        var m1 = document.getElementById(s[0]);
        for (i = 0; i <= m1.options.length; i++) {
            if (m1.options[i].value == s1) {
    ...
    if (s2 != "") {
        var m2 = document.getElementById(s[1]);
        for (i = 0; i <= m2.options.length; i++) {
            if (m2.options[i].value == s2) {
    ...
    if (s3 != "") {
        var m3 = document.getElementById(s[2]);
        for (i = 0; i <= m3.options.length; i++) {
            if (m3.options[i].value == s3) {
