/*
* 本文件为VS提供JS智能感知，仅适用于开发调试，发布时请改用其他版本
*
...
*
*
* 2009-10-22 22:44 俞翀(Michael yu) 根据官方API翻译 版权属于原作者John Resig
*/
...
(function() {
	...
	jQuery = window.jQuery = window.$ = function(selector, context) {
	    ///	<summary>
	    ///		1: $(expression, context) - 使用CSS选择器匹配查找jQuery	对象。
	    ///		2: $(html) - 使用ＨＴＭＬ字符串实时创建DOM元素。
	    ///		3: $(elements) - 将一个或多个DOM元素转化为jQuery对象。
	    ///		4: $(callback) - $(document).ready()的缩写。
	    ///	</summary>
	    ///	<param name="selector" type="String">
	    ///		1: expression - 用来查找的字符串。
	    ///		2: html - 用于动态创建DOM元素的HTML标记字符串。
	    ///		3: elements - 用于封装成jQuery对象的DOM元素。
	    ///		4: callback - 当DOM加载完成后要执行的函数	。
	    ///	</param>
	    ///	<param name="context" type="jQuery">
	    ///		1: context - （可选）作为待查找的 DOM 元素集、文档或 jQuery 对象。
	    ///	</param>
	    /// <field name="selector" Type="Object">
	    ///    jQuery 1.3新增。返回传给jQuery()的原始选择器。就是返回你用什么选择器来找到这个元素的。
	    /// </field>
	    /// <field name="context" Type="String">
	    ///    jQuery 1.3新增。返回传给jQuery()的原始的DOM节点内容，即的第二个参数。如果没有指定，那么context指向当前的文档(document)。
	    /// </field>
	    ///	<returns type="jQuery" />
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        get: function(num) {
            ///	<summary>
            ///	[核心方法]取得其中一个匹配的元素。 num表示取得第几个匹配的元素(由0开始)。这能够让你选择一个实际的DOM 元素并且对他直接操作，而不是通过 jQuery 函数。$(this).get(0)与$(this)[0]等价。
            ///	</summary>
        ...
        pushStack: function(elems, name, selector) {
            ///	<summary>
            ///		[核心方法]将一个jQuery对象加入到DOM元素数组中(非破坏性，不改变所匹配的jQuery元素的操作)
            ///	</summary>
            ///	<returns type="jQuery" />
        ...
        setArray: function(elems) {
            ///	<summary>
            ///		[核心对象]将一个jQuery对象加入到DOM元素数组中(破坏性，改变所匹配的jQuery元素的操作)
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="elems" type="Elements">
            ///		DOM元素数组
        ...
        each: function(callback, args) {
            ///	<summary>
            ///	[核心方法]以每一个匹配的元素作为上下文来执行一个函数。意味着，每次执行传递进来的函数时，函数中的this关键字都指向一个不同的DOM元素（每次都是一个不同的匹配元素）。而且，在每次执行函数时，都会给函数传递一个表示作为执行环境的元素在匹配的元素集合中所处位置的数字值作为参数（从零开始的整形）。 返回 'false' 将停止循环 (就像在普通的循环中使用 'break')。返回 'true' 跳至下一个循环(就像在普通的循环中使用'continue')。
            ///	</summary>
            ///	<returns type="jQuery" />
        ...
        attr: function(name, value, type) {
            ///	<summary>
            ///	[DOM/Attributes]	为所有匹配的元素设置一个属性值。
            ///	</summary>
            ///	<returns type="jQuery" />
        ...
        css: function(key, value) {
            ///	<summary>
            ///	[CSS]在所有匹配的元素中，设置一个样式属性的值。数字将自动转化为像素值
            ///	</summary>
            ///	<returns type="jQuery" />
        ...
        text: function(text) {
            ///	<summary>
            /// [DOM/Attributes]设置所有匹配元素的文本内容。与 html() 类似, 但将编码HTML
            ///	</summary>
            ///	<returns type="String" />
        ...
        wrapAll: function(html) {
            ///	<summary>
            ///		[DOM/Manipulation]将所有匹配的元素用单个元素包裹起来。
        ...
        wrapInner: function(html) {
            ...
            ///	HTML标记代码字符串或者DOM对象，用于动态生成元素并包装目标元素
            ///	</param>
            ///	<returns type="jQuery" />
        ...
        wrap: function(html) {
            ///	<summary>
            ///		[DOM/Manipulation]把所有匹配的元素用其他元素的结构化标记包裹起来。这种包装对于在文档中插入额外的结构化标记最有用，而且它不会破坏原始文档的语义品质。这个函数的原理是检查提供的第一个元素（它是由所提供的HTML标记代码动态生成的），并在它的代码结构中找到最上层的祖先元素－－这个祖先元素就是包裹元素。当HTML标记代码中的元素包含文本时无法使用这个函数。因此，如果要添加文本应该在包裹完成之后再行添加。
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="html" type="Element">
            ///	HTML标记代码字符串或者DOM对象
        ...
        append: function() {
            ///	<summary>
            ///		[DOM/Manipulation]向每个匹配的元素内部追加内容。这个操作与对指定的元素执行appendChild方法，将它们添加到文档中的情况类似。
            ///	</summary>
            ///	<returns type="jQuery" />
        ...
        prepend: function() {
            ///	<summary>
            ///		[DOM/Manipulation]向每个匹配的元素内部前置内容。这是向所有匹配元素内部的开始处插入内容的最佳方式。
            ///	</summary>
            ///	<returns type="jQuery" />
        ...
        before: function() {
            ///	<summary>
            ///		 [DOM/Manipulation]在每个匹配的元素之前插入内容。
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="" type="Content">
            ///	插入到每个目标前的内容
        ...
        after: function() {
            ///	<summary>
            ///		[DOM/Manipulation]在每个匹配的元素之后插入内容。
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="" type="Content">
            ///		插入到每个目标后的内容
            ...
            ///	<summary>
            ///		[DOM/Traversing]回到最近的一个"破坏性"操作之前。即，将匹配的元素列表变为前一次的状态。如果之前没有破坏性操作，则返回一个空集。所谓的"破坏性"就是指任何改变所匹配的jQuery元素的操作。这包括在 Traversing 中任何返回一个jQuery对象的函数--'add', 'andSelf', 'children', 'filter', 'find', 'map', 'next', 'nextAll', 'not', 'parent', 'parents', 'prev', 'prevAll', 'siblings' and 'slice'--再加上 Manipulation 中的 'clone'。
            ///	</summary>
            ///	<returns type="jQuery" />
        ...
        find: function(selector) {
            ///	<summary>
            ///		[DOM/Traversing]搜索所有与指定表达式匹配的元素。这个函数是找出正在处理的元素的后代元素的好方法。所有搜索都依靠jQuery表达式来完成。这个表达式可以使用CSS1-3的选择器语法来写。
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="selector" type="String">
            ///		用于查找的表达式
        ...
        clone: function(events) {
            ///	<summary>
            ///		[DOM/Manipulation]元素以及其所有的事件处理并且选中这些克隆的副本。在想把DOM文档中元素的副本添加到其他位置时这个函数非常有用。
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="deep" type="Boolean" optional="true">
            ///		(可选)设置为true可复制元素的所有事件处理
            ///	</param>
        ...
        filter: function(selector) {
            ///	<summary>
            ///		[DOM/Traversing]筛选出与指定表达式匹配的元素集合。这个方法用于缩小匹配的范围。用逗号分隔多个表达式
            ///	</summary>
            ///	<returns type="jQuery" />
        ...
        closest: function(selector) {
            ///	<summary>
            ///		jQuery 1.3新增。从元素本身开始，逐级向上级元素匹配，并返回最先匹配的元素。closest会首先检查当前元素是否匹配，如果匹配则直接返回元素本身。如果不匹配则向上查找父元素，一层一层往上，直到找到匹配选择器的元素。如果什么都没找到则返回一个空的jQuery对象。 
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="selector" type="Function">
            ///		用以过滤元素的表达式
        ...
        add: function(selector) {
            ///	<summary>
            ///		[DOM/Traversing]把与表达式匹配的元素添加到jQuery对象中。这个函数可以用于连接分别与两个表达式匹配的元素结果集
            ///	</summary>
        ...
        is: function(selector) {
            ///	<summary>
            ///		[DOM/Traversing]用一个表达式来检查当前选择的元素集合，如果其中至少有一个元素符合这个给定的表达式就返回true。如果没有元素符合，或者表达式无效，都返回'false'。 注意：在jQuery 1.3中才对所有表达式提供了支持。在先前版本中，如果提供了复杂的表达式，比如层级选择器（比如 + , ~ 和 > ），始终会返回tru
            ///	</summary>
        ...
        hasClass: function(selector) {
            ///	<summary>
            ///		检查当前的元素是否含有某个特定的CSS类，如果有，则返回true
            ///	</summary>
        ...
        val: function(value) {
            ///	<summary>
            ///		[DOM/Attributes]设置每一个匹配元素的值。
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="val" type="String">
            ///		 （可选）要设置的值。如不使用参数，则获得第一个匹配元素的当前值。
            ///	</param>
        ...
        html: function(value) {
            ///	<summary>
            ///		[DOM/Attributes]设置每一个匹配元素的html内容。
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="val" type="String">
            ///		 (可选)用于设定HTML内容的值。如果不是用参数，则取得第一个匹配元素的html内容。
            ///	</param>
        ...
        replaceWith: function(value) {
            ...
            ///	</summary>
            ///	<param name="value" type="String">
            ///		用于将匹配元素替换掉的内容(String, Element, jQuery)
            ///	</param>
            ///	<returns type="jQuery">刚刚替换的元素</returns>
        ...
        slice: function() {
            ...
            ///		选取一个匹配的子集
            ///	</summary>
            ///	<param name="start" type="Number" integer="true">开始选取子集的位置。第一个元素是0.</param>
            ///	<param name="end" optional="true" type="Number" integer="true">(可选)结束选取自己的位置，如果不指定，则就是本身的结尾。</param>
            ///	<returns type="jQuery">子集元素</returns>
    ...
    jQuery.extend = jQuery.fn.extend = function() {
        ///	<summary>
        ///		[JavaScript]扩展jQuery对象本身，返回原始的被修改过的对象(Jquery插件机制)
    ...
    jQuery.extend({
        noConflict: function(deep) {
            ///	<summary>
            ///		[核心方法]运行这个函数将变量$的控制权让渡给第一个实现它的那个库。这有助于确保jQuery不会与其他库的$对象发生冲突。在运行这个函数后，就只能使用jQuery变量访问jQuery对象。例如，在要用到$("div p")的地方，就必须换成jQuery("div p")。 
            ///	</summary>
        ...
        isFunction: function(obj) {
            ...
            ///		测试对象是否为函数。
            ///	</summary>
            ///	<param name="obj" type="Object">用于测试是否为函数的对象</param>
        ...
        isArray: function(obj) {
            ...
            ///		测试对象是否为数组。
            ///	</summary>
            ///	<param name="obj" type="Object">用于测试是否为数组的对象</param>
            ///	<returns type="Boolean">True if the parameter is a function; otherwise false.</returns>
        ...
        isXMLDoc: function(elem) {
            ...
            ///		测试对象是否为XML文档。
            ///	</summary>          
            ///	<param name="elem" type="Object">用于测试是否为XML</param>
        ...
        globalEval: function(data) {
            ...
            ///	</summary>
            ///	<param name="data" type="String">待载入 JS 文件地址。</param>
            ///	<private />
        ...
        nodeName: function(elem, name) {
            ...
            ///	<param name="name" type="String">节点名</param>
        ...
        each: function(object, callback, args) {
            ///	<summary>
            ///		[JavaScript]通用例遍方法，可用于例遍对象和数组。不同于例遍 jQuery 对象的 $().each() 方法，此方法可用于例遍任何对象。回调函数拥有两个参数：第一个为对象的成员或数组的索引，第二个为对应变量或内容。如果需要退出 each 循环可使回调函数返回 false，其它返回值将被忽略。
            ///	</summary>
        ...
        prop: function(elem, value, type, i, name) {
            ...
            ///	</summary>
            ///	<private />
            // This member is not documented within the : http://docs.jquery.com/action/edit/Internals/jQuery.prop
        ...
        inArray: function(elem, array) {
            ...
            ///	</summary>
            ///	<param name="elem">用于在数组中查找是否存在</param>
            ///	<param name="array" type="Array">待处理数组。</param>
            ///	<returns type="Number" integer="true">从0开始计数(如果没有找到则返回 -1 .</returns>
        ...
        merge: function(first, second) {
            ///	<summary>
            ///		[JavaScript]合并两个数组。返回的结果会修改第一个数组的内容——第一个数组的元素后面跟着第二个数组的元素。要去除重复项，请使用$.unique()
            ///	</summary>
            ///	<returns type="Array" />
        ...
        unique: function(array) {
            ...
            ///	</summary>
            ///	<param name="array" type="Array&lt;Element&gt;">待处理数组。</param>
        ...
        grep: function(elems, callback, inv) {
            ///	<summary>
            ///		[JavaScript]使用过滤函数过滤数组元素。此函数至少传递两个参数：待过滤数组和过滤函数。过滤函数必须返回 true 以保留元素或 false 以删除元素。      ///	</summary>
            ///	<returns type="Array" />
        ...
        map: function(elems, callback) {
            ///	<summary>
            ///		[JavaScript]将一个数组中的元素转换到另一个数组中。作为参数的转换函数会为每个数组元素调用，而且会给这个转换函数传递一个表示被转换的元素作为参数。转换函数可以返回转换后的值、null（删除数组中的项目）或一个包含值的数组，并扩展至原始数组中
            ///	</summary>
            ///	<returns type="Array" />
            ///	<param name="elems" type="Array">
            ///		待转换数组。
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>
            ///	[DOM/Traversing]取得一个包含着所有匹配元素的唯一父元素的元素集合。
            ///	</summary>
            ///	<param name="expr" type="String" optional="true">
            ///	(可选)用来筛选的表达式
            ///	</param>
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>
            ///	[DOM/Traversing]取得一个包含着所有匹配元素的祖先元素的元素集合（不包含根元素）。可以通过一个可选的表达式进行筛选。
            ///	</summary>
            ///	<param name="expr" type="String" optional="true">
            ///	(可选)用来筛选的表达式
            ///	</param>
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>
            ///	[DOM/Traversing]取得一个包含匹配的元素集合中每一个元素紧邻的后面同辈元素的元素集合。这个函数只返回后面那个紧邻的同辈元素，而不是后面所有的同辈元素（可以使用nextAll）。可以用一个可选的表达式进行筛选。
            ///	</summary>
            ///	<param name="expr" type="String" optional="true">
            ///	(可选)用来筛选的表达式
            ///	</param>
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>
            ///	[DOM/Traversing]取得一个包含匹配的元素集合中每一个元素紧邻的前一个同辈元素的元素集合。可以用一个可选的表达式进行筛选。只有紧邻的同辈元素会被匹配到，而不是前面所有的同辈元素。
            ///	</summary>
            ///	<param name="expr" type="String" optional="true">
            ///	(可选)用来筛选的表达式
            ///	</param>
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>
            ///	[DOM/Traversing]查找当前元素之后所有的同辈元素。
            ///	</summary>
            ///	<param name="expr" type="String" optional="true">
            ///	(可选)用来筛选的表达式
            ///	</param>
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>
            ///	[DOM/Traversing]查找当前元素之前所有的同辈元素。
            ///	</summary>
            ///	<param name="expr" type="String" optional="true">
            ///	(可选)用来筛选的表达式
            ///	</param>
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>
            ///	[DOM/Traversing]取得一个包含匹配的元素集合中每一个元素的所有唯一同辈元素的元素集合。可以用可选的表达式进行筛选。
            ///	</summary>
            ///	<param name="expr" type="String" optional="true">
            ///	(可选)用来筛选的表达式
            ///	</param>
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>
            ///	[DOM/Traversing]取得一个包含匹配的元素集合中每一个元素的所有子元素的元素集合。可以通过可选的表达式来过滤所匹配的子元素。注意：parents()将查找所有祖辈元素，而children()只考虑子元素而不考虑所有后代元素。
            ///	</summary>
            ///	<param name="expr" type="String" optional="true">
            ///	(可选)用以过滤子元素的表达式
            ///	</param>
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ///	<summary>查找匹配元素内部所有的子节点（包括文本节点）。如果元素是一个iframe，则查找文档内容</summary>
            ///	<returns type="jQuery" />
    ...
    jQuery.fn.appendTo = function(selector) {
        ///	<summary>
        ///		把所有匹配的元素追加到另一个指定的元素元素集合中。实际上，使用这个方法是颠倒了常规的$(A).append(B)的操作，即不是把B追加到A中，而是把A追加到B中。 在jQuery 1.3.2中，appendTo, prependTo, insertBefore, insertAfter, 和 replaceAll这个几个方法成为一个破坏性操作，返回值是所有被追加的内容，而不仅仅是先前所选中的元素。所以，要选择先前选中的元素，需要使用end()方法
        ///	</summary>
    ...
    jQuery.fn.insertBefore = function(selector) {
        ///	<summary>
        ///		把所有匹配的元素插入到另一个、指定的元素元素集合的前面。实际上，使用这个方法是颠倒了常规的$(A).before(B)的操作，即不是把B插入到A前面，而是把A插入到B前面。 在jQuery 1.3.2中，appendTo, prependTo, insertBefore, insertAfter, 和 replaceAll这个几个方法成为一个破坏性操作，要选择先前选中的元素，需要使用end()方法
        ///	</summary>
    ...
    jQuery.fn.insertAfter = function(selector) {
        ///	<summary>
        ///		把所有匹配的元素插入到另一个、指定的元素元素集合的后面。实际上，使用这个方法是颠倒了常规的$(A).after(B)的操作，即不是把B插入到A后面，而是把A插入到B后面。 在jQuery 1.3.2中，appendTo, prependTo, insertBefore, insertAfter, 和 replaceAll这个几个方法成为一个破坏性操作，要选择先前选中的元素，需要使用end()方法
        ///	</summary>
        ///	<param name="content" type="String">
        ///		 用于匹配元素的jQuery表达式
        ///	</param>
    ...
    jQuery.fn.replaceAll = function(selector) {
        ///	<summary>
        ///		用匹配的元素替换掉所有 selector匹配到的元素。在jQuery 1.3.2中，appendTo, prependTo, insertBefore, insertAfter, 和 replaceAll这个几个方法成为一个破坏性操作，要选择先前选中的元素，需要使用end()方法
        ///	</summary>
        ///	<param name="selector" type="Selector">用于查找所要被替换的元素</param>
        ///	<returns type="jQuery" />
        var ret = [], insert = jQuery(selector);
    ...
    jQuery.fn.removeAttr = function() {
        ///	<summary>
        ///		[DOM/Attributes]从每一个匹配的元素中删除一个属性
        ///	</summary>
        ///	<param name="key" type="String">
        ///		要删除的属性名
        ///	</param>
    ...
    jQuery.fn.addClass = function() {
        ///	<summary>
        ///		[DOM/Attributes]为每个匹配的元素添加指定的CSS类
        ///	</summary>
    ...
    jQuery.fn.removeClass = function() {
        ///	<summary>
        ///		[DOM/Attributes]从所有匹配的元素中删除全部或者指定的类。
        ///	</summary>
    ...
    jQuery.fn.toggleClass = function() {
        ///	<summary>
        ///		[DOM/Attributes]如果存在（不存在）就删除（添加）一个类。
        ///	</summary>
    ...
    jQuery.fn.remove = function() {
        ///	<summary>
        ///		[DOM/Manipulation]从DOM中删除所有匹配的元素。这个方法不会把匹配的元素从jQuery对象中删除，因而可以在将来再使用这些匹配的元素。
        ///	</summary>
        ///	<param name="expr" type="String" optional="true">
        ///		(可选)用于筛选元素的jQuery表达式
        ///	</param>
    ...
    jQuery.fn.empty = function() {
        ///	<summary>
        ///		[DOM/Manipulation]删除匹配的元素集合中所有的子节点。
        ///	</summary>
        ///	<returns type="jQuery" />
        return this.each(function() {
            // Remove element nodes and prevent memory leaks
    ...
    jQuery.fn.extend({
        ...
        queue: function(type, data) {
            ...
            ///		2: queue(callback) - 在匹配的元素的队列最后添加一个函数
            ///		3: queue(queue) - 将匹配元素的队列用新的一个队列来代替(函数数组).
            ///	</summary>
    ...
    */
    ...
    jQuery.fn.extend({
        bind: function(type, data, fn) {
            ...
            ///	</summary>
            ///	<param name="type" type="String">一个或多个事件，用空格分开。可使用: blur, focus, load, resize, scroll, unload, click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, mouseenter, mouseleave, change, select, submit, keydown, keypress, keyup, error .</param>
            ///	<param name="data" optional="true" type="Object">(可选)作为event.data属性值传递给事件对象的额外数据对象</param>
            ///	<param name="fn" type="Function">绑定到每个匹配元素的事件上面的处理函数</param>
        ...
        unbind: function(type, fn) {
            ...
            ///	</summary>
            ///	<param name="type" type="String">（可选）一个或多个事件，用空格分开。可使用: blur, focus, load, resize, scroll, unload, click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, mouseenter, mouseleave, change, select, submit, keydown, keypress, keyup, error .</param>
            ///	<param name="fn" type="Function">（可选）要从每个匹配元素的事件中反绑定的事件处理函数</param>
        ...
        trigger: function(type, data) {
            ///	<summary>
            ///		在每一个匹配的元素上触发某类事件。这个函数也会导致浏览器同名的默认行为的执行。比如，如果用trigger()触发一个'submit'，则同样会导致浏览器提交表单。如果要阻止这种默认行为，应返回false。 你也可以触发由bind()注册的自定义事件而不限于浏览器默认事件。 jQuery 1.3中新增： 所有触发的事件现在会冒泡到DOM树上了。举例来说，如果你在一个段落p上触发一个事件，他首先会在这个元素上触发，其次到父元素，在到父元素的父元素，直到触发到document对象。这个事件对象有一个 .target 属性指向最开始触发这个事件的元素。你可以用 stopPropagation() 来阻止事件冒泡，或者在事件处理函数中返回false即可。 
            ///	</summary>
            ///	<param name="type" type="String">一个或多个事件，用空格分开。可使用:  blur, focus, load, resize, scroll, unload, click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, mouseenter, mouseleave, change, select, submit, keydown, keypress, keyup, error .</param>
        ...
        triggerHandler: function(type, data) {
            ///	<summary>
            ///	该方法将会触发指定的事件类型上所有绑定的处理函数。但不会执行浏览器默认动作，也不会产生事件冒泡。这个方法的行为表现与trigger类似，但有以下三个主要区别： * 第一，他不会触发浏览器默认事件。 * 第二，只触发jQuery对象集合中第一个元素的事件处理函数。 * 第三，这个方法的返回的是事件处理函数的返回值，而不是据有可链性的jQuery对象。此外，如果最开始的jQuery对象集合为空，则这个方法返回 undefined 。
            ///	</summary>
            ///	<param name="type" type="String">一个或多个事件，用空格分开。可使用: blur, focus, load, resize, scroll, unload, click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, mouseenter, mouseleave, change, select, submit, keydown, keypress, keyup, error .</param>
            ///	<param name="data" optional="true" type="Array">(可选)传递给事件处理函数的附加参数</param>
            ///	<param name="fn" type="Function">This parameter is undocumented.</param>
        ...
        toggle: function(fn) {
            ...
            ///	轮流执行2个或多个方法
            ///	</summary>
            ///	<param name="fn" type="Function">轮换执行的方法</param>
        ...
        ready: function(fn) {
            ...
            ///	</summary>
            ///	<param name="fn" type="Function">要在DOM就绪时执行的函数</param>
        ...
        live: function(type, fn) {
            ///	<summary>
            ///	jQuery 1.3中新增的方法。给所有当前以及将来会匹配的元素绑定一个事件处理函数（比如click事件）。也能绑定自定义事件。目前支持 click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, keydown, keypress, keyup。 还不支持 blur, focus, mouseenter, mouseleave, change, submit 。与bind()不同的是，live()一次只能绑定一个事件。 
            ///	</summary>
            ///	<param name="type" type="String">事件类型</param>
            ///	<param name="fn" type="Function">欲绑定的事件处理函数</param>
        ...
        die: function(type, fn) {
            ///	<summary>
            ///		jQuery 1.3新增。此方法与live正好完全相反。如果不带参数，则所有绑定的live事件都会被移除。 你可以解除用live注册的自定义事件。如果提供了type参数，那么会移除对应的live事件。 如果也指定了第二个参数function,则只移出指定的事件处理函数。
            ///	</summary>
            ///	<param name="type" type="String"> (可选)要解除绑定的live事件</param>
            ///	<param name="fn" type="Function">(可选)要解除绑定的特定处理函数</param>
    ...
    jQuery.fn["blur"] = function(fn) {
        ///	<summary>
        ///		1: blur() -触发每一个匹配元素的blur事件。
        ///		2: blur(fn) - 在每一个匹配元素的blur事件中绑定一个处理函数。
        ///	</summary>
        ///	<param name="fn" type="Function">待执行函数</param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn["focus"] = function(fn) {
        ///	<summary>
        ///		1: focus() - 触发每一个匹配元素的focus事件。
        ///		2: focus(fn) - 在每一个匹配元素的focus事件中绑定一个处理函数。
        ///	</summary>
        ///	<param name="fn" type="Function">待执行函数</param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn["resize"] = function(fn) {
        ...
        ///		2: resize(fn) - 在每一个匹配元素的resize事件中绑定一个处理函数。
        ///	</summary>
        ///	<param name="fn" type="Function">待执行函数</param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn["scroll"] = function(fn) {
        ...
        ///		2: scroll(fn) - 在每一个匹配元素的scroll事件中绑定一个处理函数。
        ///	</summary>
        ///	<param name="fn" type="Function">待执行函数</param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn["unload"] = function(fn) {
        ...
        ///		2: unload(fn) - 在每一个匹配元素的unload事件中绑定一个处理函数。
        ///	<param name="fn" type="Function">待执行函数</param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn["click"] = function(fn) {
        ...
        ///		2: click(fn) - 在每一个匹配元素的click事件中绑定一个处理函数。
        ///	</summary>
        ///	<param name="fn" type="Function">待执行函数</param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn["error"] = function(fn) {
        ...
        ///		2: keyerrorup(fn) - 在每一个匹配元素的error事件中绑定一个处理函数。  
        ///	</summary>
        ///	<param name="fn" type="Function">待执行函数</param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn.extend({
        ...
        load: function(url, params, callback) {
            ...
            ///	<param name="data" optional="true" type="Map">(可选)发送至服务器的 key/value 数据。在jQuery 1.3中也可以接受一个字符串了。</param>
            ///	<param name="callback" optional="true" type="Function">Ajax载入成功时回调函数。 function(responseText, textStatus, XMLHttpRequest) </param>
            ///	<returns type="jQuery" />
        ...
        serializeArray: function() {
            ///	<summary>
            ///		序列化表格元素 (类似 '.serialize()' 方法) 返回 JSON 数据结构数据。注意，此方法返回的是JSON对象而非JSON字符串。需要使用插件或者第三方库进行字符串化操作。
            ///	</summary>
    ...
    jQuery.fn["ajaxStart"] = function(callback) {
        ...
        ///	</summary>
        ///	<param name="callback" type="Function">待执行函数</param>
        ///	<returns type="jQuery" />
    ...
    jQuery.extend({
        ...
        get: function(url, data, callback, type) {
            ///	<summary>
            ///	[Ajax]	通过远[Ajax]程 HTTP GET 请求载入信息。
            ///	</summary>
            ///	<param name="url" type="String">待载入页面的URL地址</param>
            ///	<param name="data" optional="true" type="Map">待发送 Key/value 参数。</param>
            ///	<param name="callback" optional="true" type="Function">(可选)载入成功时回调函数。 function(responseText, textStatus)</param>
            ///	<param name="type" optional="true" type="String">返回内容格式 xml, html, script, json, text, _default.</param>
        ...
        getScript: function(url, callback) {
            ///	<summary>
            ///[Ajax]   通过 HTTP GET 请求载入并执行一个 JavaScript 文件。
            ///	</summary>
            ///	<param name="url" type="String">待载入 JS 文件地址</param>
            ///	<param name="callback" optional="true" type="Function">成功载入后回调函数。function(data, textStatus) </param>
            ///	<returns type="XMLHttpRequest" />
        ...
        ajax: function(s) {
            ///	<summary>
            ///		通过 HTTP 请求加载远程数据。jQuery 底层 AJAX 实现。简单易用的高层实现见 $.get, $.post 等。$.ajax() 返回其创建的 XMLHttpRequest 对象。大多数情况下你无需直接操作该对象，但特殊情况下可用于手动终止请求。$.ajax() 只有一个参数：参数 key/value 对象，包含各配置及回调函数信息。详细参数选项见下。 注意： 如果你指定了 dataType 选项，请确保服务器返回正确的 MIME 信息，(如 xml 返回 "text/xml")。错误的 MIME 类型可能导致不可预知的错误。见 Specifying the Data Type for AJAX Requests 。 注意：如果dataType设置为"script"，那么在远程请求时(不在同一个域下)，所有POST请求都将转为GET请求。(因为将使用DOM的script标签来加载) 
            ///	</summary>
            ///	<private />
        ...
        param: function(a) {
            ///	<summary>
            ///		该方法仅供内部调用  Use serialize() instead.
            ///	</summary>
    ...
    jQuery.fn.extend({
        show: function(speed, callback) {
            ///	<summary>
            ///	以优雅的动画显示所有匹配的元素，并在显示完成后可选地触发一个回调函数。不使用参数则无动画效果。
            ///	</summary>
            ///	<param name="speed" type="String,Number">(可选)三种预定速度之一的字符串("slow", "normal", or "fast")或表示动画时长的毫秒数值(如：1000)</param>
        ...
        hide: function(speed, callback) {
            ///	<summary>
            ///	以优雅的动画隐藏所有匹配的元素，并在显示完成后可选地触发一个回调函数。不使用参数则无动画效果。
            ///	</summary>
            ///	<param name="speed" type="String,Number">(可选)三种预定速度之一的字符串("slow", "normal", or "fast")或表示动画时长的毫秒数值(如：1000)</param>
            ///	<param name="callback" optional="true" type="Function">(可选)在动画完成时执行的函数，每个元素执行一次。</param>
            ///	<returns type="jQuery" />
        ...
        fadeTo: function(speed, to, callback) {
            ...
            ///	</summary>
            ///	<param name="speed" type="String,Number">三种预定速度之一的字符串("slow", "normal", or "fast")或表示动画时长的毫秒数值(如：1000)</param>
            ///	<param name="to" type="Number">要调整到的不透明度值(0到1之间的数字)</param>
            ///	<param name="callback" optional="true" type="Function">在动画完成时执行的函数</param>
            ///	<returns type="jQuery" />
        ...
        animate: function(prop, speed, easing, callback) {
            ///	<summary>
            ///		用于创建自定义动画的函数。这个函数的关键在于指定动画形式及结果样式属性对象。这个对象中每个属性都表示一个可以变化的样式属性（如“height”、“top”或“opacity”）。注意：所有指定的属性必须用骆驼形式，比如用marginLeft代替margin-left. 而每个属性的值表示这个样式属性到多少时动画结束。如果是一个数值，样式属性就会从当前的值渐变到指定的值。如果使用的是“hide”、“show”或“toggle”这样的字符串值，则会为该属性调用默认的动画形式。
            ///	</summary>
            ...
            ///	<param name="callback" optional="true" type="Function">（可选）在动画完成时执行的函数 function callback() </param>
            ///	<returns type="jQuery" />
        ...
        stop: function(clearQueue, gotoEnd) {
            ...
            ///	</summary>
            ///	<param name="clearQueue" optional="true" type="Boolean">（可选）如果设置成true，则清空队列。可以立即结束动画。</param>
            ///	<param name="gotoEnd" optional="true" type="Boolean">（可选）让当前正在执行的动画立即完成，并且重设show和hide的原始样式，调用回调函数等。</param>
            ///	<returns type="jQuery" />
    ...
    jQuery.fn.slideUp = function(speed, callback) {
        ///	<summary>
        ///		通过高度变化（向上减小）来动态地显示所有匹配的元素，在显示完成后可选地触发一个回调函数。这个动画效果只调整元素的高度，可以使匹配的元素以“滑动”的方式显示出来。在jQuery 1.3中，上下的padding和margin也会有动画，效果更流畅。
        ///	</summary>
        ///	<param name="speed" type="String,Number">三种预定速度之一的字符串("slow", "normal", or "fast")或表示动画时长的毫秒数值(如：1000)</param>
        ///	<param name="callback" optional="true" type="Function">（可选）在动画完成时执行的函数 function callback() </param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn.slideToggle = function(speed, callback) {
        ///	<summary>
        ///		通过高度变化来切换所有匹配元素的可见性，在显示完成后可选地触发一个回调函数。这个动画效果只调整元素的高度，可以使匹配的元素以“滑动”的方式显示出来。在jQuery 1.3中，上下的padding和margin也会有动画，效果更流畅。
        ///	</summary>
        ///	<param name="speed" type="String,Number">三种预定速度之一的字符串("slow", "normal", or "fast")或表示动画时长的毫秒数值(如：1000)</param>
        ///	<param name="callback" optional="true" type="Function">（可选）在动画完成时执行的函数 function callback() </param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn.fadeIn = function(speed, callback) {
        ///	<summary>
        ///		通过不透明度的变化来实现所有匹配元素的淡入效果，在显示完成后可选地触发一个回调函数。这个动画效果只调整元素的高度，可以使匹配的元素以“滑动”的方式显示出来。在jQuery 1.3中，上下的padding和margin也会有动画，效果更流畅。
        ///	</summary>
        ///	<param name="speed" type="String,Number">三种预定速度之一的字符串("slow", "normal", or "fast")或表示动画时长的毫秒数值(如：1000)</param>
        ///	<param name="callback" optional="true" type="Function">（可选）在动画完成时执行的函数 function callback() </param>
        ///	<returns type="jQuery" />
    ...
    jQuery.fn.fadeOut = function(speed, callback) {
        ///	<summary>
        ///		通过不透明度的变化来实现所有匹配元素的淡出效果，在显示完成后可选地触发一个回调函数。这个动画效果只调整元素的高度，可以使匹配的元素以“滑动”的方式显示出来。在jQuery 1.3中，上下的padding和margin也会有动画，效果更流畅。
        ///	</summary>
        ///	<param name="speed" type="String,Number">三种预定速度之一的字符串("slow", "normal", or "fast")或表示动画时长的毫秒数值(如：1000)</param>
        ///	<param name="callback" optional="true" type="Function">（可选）在动画完成时执行的函数 function callback() </param>
        ///	<returns type="jQuery" />
    ...
    if (document.documentElement["getBoundingClientRect"])
        jQuery.fn.offset = function() {
            ...
            ///	</summary>
            ///	<returns type="Object">返回的对象包含两个整形属性：top 和 left。</returns>
    ...
    jQuery.fn.extend({
        position: function() {
            ///	<summary>
            ///	获取匹配元素相对父元素的偏移。为精确计算结果，请在补白、边框和填充属性上使用像素单位。此方法只对可见元素有效。
            ///	</summary>
            ///	<returns type="Object">返回的对象包含两个整形属性：top 和 left。</returns>
    ...
    jQuery.each(["Height"], function(i, name) {
        ...
        jQuery.fn["inner" + name] = function() {
            ///	<summary>
            ///	获取第一个匹配元素内部区域宽/高（包括补白、不包括边框）。此方法对可见和隐藏元素均有效。
            ///	</summary>
        ...
        jQuery.fn["outer" + name] = function(margin) {
            ///	<summary>
            ///	获取第一个匹配元素外部区域宽/高（默认包括补白和边框）。此方法对可见和隐藏元素均有效。
            ///	</summary>
            ///	<returns type="Number" integer="true">The outer height of the first matched element.</returns>
            return this[0] ?
    ...
    jQuery.each(["Width"], function(i, name) {
        ...
        jQuery.fn["outer" + name] = function(margin) {
            ///	<summary>
            ///	获取第一个匹配元素外部区域宽/高（包括补白、不包括边框）。此方法对可见和隐藏元素均有效。
            ///	</summary>
            ///	<returns type="Number" integer="true">The outer height of the first matched element.</returns>
            return this[0] ?
			jQuery.css(this[0], lower, false, margin ? "margin" : "border") :
