...
String.prototype.tran = function() {
    var s1, s2;
    if (zh_choose == 't') { s1 = zh_s; s2 = zh_t; }
    else if (zh_choose == 's') { s1 = zh_t; s2 = zh_s; }
    else { return this; }
    var a = '';
    var l = this.length;
...
function zh_tranBody(obj) {
    ...
    for (var i = 0; i < o.length; i++) {
        ...
        if (c.nodeType == 3) { c.data = c.data.tran(); }
        else { zh_tranBody(c); }
    }
}
...
function zh_tran(go) {
    ...
    if (go == 'n') { window.location.reload(); }
    else { zh_tranBody(); }
}
...
function zh_getLang() {
    ...
    else if (zh_autoLang_s && zh_langReg_s.test(zh_browserLang)) { zh_choose = 's'; }
