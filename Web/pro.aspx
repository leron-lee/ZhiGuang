...
<style>
    .datable td { width: 33%; border: 1px solid #D9D9D9; }
    .datable td a { display: block; height: 30px; line-height: 30px;text-align:center; }
    .datable td a.a { color: #E33638; }
</style>
    ...
    <div class="b_l_w">
        ...
        <ItemTemplate>
            <div style="border:1px solid #ccc;padding:5px;border-radius:5px;">
                <div class="w100">
                    <div class="b_l_w">
                        <a href="pro_l.aspx?id=<%#Eval("id") %>"><img src="<%#Eval("x_img") %>" height="140px" width="100%" class="now" /></a>
                    </div>
