...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        TypeConfig["Flash"].AllowedExtensions = new string[] { "swf", "flv", "swf", "swf", "flv", "fla", "mpg", "asf", "wma", "wmv", "avi", "mov", "mp3", "rmvb", "rm", "mid", "flv", "fla", "mpg", "asf", "wma", "wmv", "avi", "mov", "mp3", "rmvb", "rm", "mid" };
