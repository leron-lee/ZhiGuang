...
namespace Web.user
{
    public partial class chongzhi_xfj : System.Web.UI.Page
    {
        ...
        {
            string s = this.s1.SelectedValue;
            if (s != "")
            {
                if (System.Convert.ToInt32(s) > 0)
                {
                    ...
                    string sql = "insert into chongzhi_xfj (ordernumber,zt,price,username) values(@ordernumber,@zt,@price,@username)";
