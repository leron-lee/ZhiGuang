...
namespace Web.user
{
    public partial class dongtai_hb : System.Web.UI.Page
    {
        public string fystr;
        ...
        public void fy()
        {
            ...
            else
            {
                ...
                string nid = new SqlHelper().ExecuteScalar("select top 1 id from hb_jilu where id in (" + sqlabc + ") order by id");
                sqlstring = string.Concat(new object[]
				{
					"select top ",
					x,
            ...
            this.fystr = en_page.fystr_one(x, "hb_jilu where id <> 0 " + sqlw, url, p, "pagex", "id", 2);
        }
    }
}