...
<ul class="navLocation"><li><strong>基本信息设置</strong></li></ul>
    ...
    <div class="infoBox">
            ...
            <tr>
                ...
                <td style="padding:5px 0px 5px 0px;line-height:23px;">
                    1.进入“公众号设置”》“功能设置”里填写“JS接口安全域名”。<br />
            ...
            <style>
                #idsdg td{border:0px;padding:5px 0px 0px 0px;}
                #idsdg td img{padding-bottom:5px;}
                #idsdg2 td{border:0px;padding:5px 0px 0px 0px;}
                #idsdg2 td img{padding-bottom:5px;}
            </style>
