<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_master.Master" AutoEventWireup="true" CodeBehind="menu_one_in.aspx.cs" Inherits="Web.admin.wx.menu_one_in" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
<ul class="navLocation">
    <li><strong><%=tit %>一级菜单</strong></li>
</ul>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="b_l_w" style="line-height:23px;">
                        <b>注：</b>如果此一级菜单有二级菜单链接功能就自动失效<br />
