<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_master.Master" AutoEventWireup="true" CodeBehind="uppassword.aspx.cs" Inherits="Web.admin.uppassword.uppassword" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">

<ul class="navLocation"><li><strong>修改密码</strong></li></ul>
            ...
            <fieldset>
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td>
                        <asp:TextBox ID="TextBox1" MaxLength="50"  runat="server" CssClass="formTitle"></asp:TextBox>
