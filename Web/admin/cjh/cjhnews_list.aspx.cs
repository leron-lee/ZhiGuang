...
{
    public partial class cjhnews_list : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.Literal1.Text = liu.fystr_new(x, "cjh_news where" + sqlwere, username, p, "pagex", "id");
        ...
        protected void Rp_OnItemCommand(object o, RepeaterCommandEventArgs e)
        {
            ...
            {
                string sqlstring = "delete from cjh_news where id=" + e.CommandArgument;
        ...
        public string GG(object q)
        {
            ...
            using (DataTable dt = new SqlHelper().ExecuteDataTable("select * from cjh where id=" + q))
            {
