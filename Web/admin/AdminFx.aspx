<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFx.aspx.cs" Inherits="Web.admin.AdminFx" %>
...
<div id="sidebar"><a href="javascript:;" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu open"><a href="javascript:;"><i class="icon icon-list-alt"></i> <span>栏目管理 ⅴ</span></a>
        <ul>
