<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_master.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Web.admin.hb.Default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<link href="../css/dntmanager.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <ul class="navLocation"><li><strong>红包管理</strong></li></ul>
    <div class="b_l_w">
        <div style="padding:5px;">
            ...
            <asp:Panel ID="Panel2" CssClass="ManagerForm" runat="server" DefaultButton="search_bt">
                    <fieldset>
                        <legend style="background:url(../images/icons/icon44.jpg) no-repeat 6px 50%;">红包记录</legend>
